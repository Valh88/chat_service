defmodule Db.Messages do
  ...
  def create_undelivered(user_id, message, from_id) do
    %Message{}
    |> Message.changeset(%{user_id: user_id, message: message, from_user_id: from_id, status: "undelivered"})
    |> Repo.insert()
  end

  def create_delivered(user_id, message, from_id) do
    %Message{}
    |> Message.changeset(%{user_id: user_id, message: message, from_user_id: from_id, status: "delivered"})
    |> Repo.insert()
  end
